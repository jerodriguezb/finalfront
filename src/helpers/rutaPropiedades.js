...
export const getPropiedades = async (desde = 0, limite = 50) => {
  let url = `https://damp-falls-98546.herokuapp.com/propiedades?desde=${desde}&limite=${limite}`;
  const options = {
    method: "GET",
    headers: {
...
export const getPropiedadId = async (id) => {
  let url = `https://damp-falls-98546.herokuapp.com/propiedades/${id}`;
  const options = {
    method: "GET",
    headers: {
      "content-type": "application/x-www-form-urlencoded",
...
export const addPropiedad = async (datos) => {
  ...
  let url = "https://damp-falls-98546.herokuapp.com/propiedades";
  const options = {
    method: "POST",
    headers: {
      "content-type": "application/x-www-form-urlencoded",
